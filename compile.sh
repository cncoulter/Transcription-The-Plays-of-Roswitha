...
# This script uses pandoc to export the transcriptions to TXT, MD, HTML, EPUB, ODT, DOCX, and PDF file formats

pandoc -S -s "README.md" "01 Translators Note.md" "02 Introduction.md" "03 Critical Preface.md" "04 The Prefaces of Roswitha.md" "05 Gallicanus.md" "06 Dulcitius.md" "07 Callimachus.md" "08 Abraham.md" "09 Paphnutius.md" "10 Sapientia.md" "11 Note on the Acting of the Plays.md" -t plain -o "./Compiled/The Plays of Roswitha.txt"
